...
function generateDeletionLink1() {
    ...
    html += '<div>';
    html += '<blockquote><strong>[[iframe https://hoah2333.github.io/thebackhubscn/Deletion%20Time%20Tool/Deletion%20Time%20Tool.html?timestamp=' + timestamp.getTime() + '&type=' + type + ' style="width: 400px; height: 51px;"]]</strong></blockquote>';
    html += '</div>';
    html += '<div>';
    html += '<iframe src="https://hoah2333.github.io/thebackhubscn/Deletion%20Time%20Tool/Deletion%20Time%20Tool.html?timestamp=' + timestamp.getTime() + '&type=' + type + '" style="width: 400px; height: 51px;"></iframe>';
    html += '</div>';
    $('#generated').html(html);
}
